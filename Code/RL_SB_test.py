...
from Env_Final_without_test import _GymSumo_without
from Env_Final_test import _GymSumo
import numpy as np
...
if __name__ == '__main__':
    ...
    full_path = os.path.join("C:\\Users\\Dell\\Desktop\\New\\logs\\A2C_0_test", current_date)
    # model = A2C.load("C:\\Users\\Dell\\Desktop\\New\\model\\RL1.zip",env=envs)
    ...
    log_dir = os.path.join("C:\\Users\\Dell\\Desktop\\New\\plot_folder_test")
    ...
    for i in range(100):
        ...
        if dis < D2D:
            model.save("C:\\Users\\Dell\\Desktop\\New\\model\\RL{}".format(dis))
            D2D = dis 
        elif dis < 20:
            name = str(dis) + '_' + str(num)
            model.save("C:\\Users\\Dell\\Desktop\\New\\model\\RL"+name)
            num += 1
